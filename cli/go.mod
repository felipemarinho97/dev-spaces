module github.com/felipemarinho97/dev-spaces/cli
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/apigateway v1.13.0 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/s3control v1.18.0 // indirect
